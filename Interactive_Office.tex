...
we are three students doing a project for the course ``Designing Interactive Systems'' held by 
alvatore Andolina. The goal of this project is to improve the well-being of people working in an 
office environment by helping them to have better breaks.

But what are ``better'' breaks? To improve on existing ideas and find new ideas we would like to 
invite you to a Crowdboard-Session (Insert Link to session here) 
on Thursday, 23rd March 2017, 14:30. The Crowdboard is an augmented whiteboard which enables you to 
help us by adding input directly to the whiteboard - either by commenting on existing ideas or 
putting new ideas up.

Because the Crowdboard is still in development and too many comments/ideas would overwhelm us, there
will be a limit of 20/30 people that can add comments. 
