...
The goal of our research is to suggest development possibilities to any office environment. Through literature review, observation and semi structured interviews we identified, that regular break habits lead not only to more effective work, but also create a better atmosphere. As a result, relationships between co-workers develop, inhibitions disappear and work-culture gets better. However, some employees may not take breaks regularly or have strong relationships with their colleagues. 

There is a need for a tool which can help individuals to take breaks more regularly in a fun and interactive way. In our study, a software solution designed for this purpose was developed. The software aims to improve regularity of breaks taken in any office environment by matching random colleagues with similar interests and professional background for spending breaks together.  
\end{abstract}
