...
\begin{quote}
  We discuss long using Crowdboard to involve external sources for finding ideas - we considered it 
  as a good idea - Salvatore will help us to arrange this next week in the same time slot - we will 
  have to prepare the initial task for further needfinding for our project on the focus of breaks by 
  tomorrow evening
\end{quote}
...
\begin{quote}
   ...
   * we are currently doing a project in the course ``Designing Interactive Systems'' held by 
     Salvatore Andolina
   * The goal of our project is to improve the well-being of people working in an office environment
   * We'd like to invite you  to a [Crowdboard-Session] on Thursday, 23rd March 2017, 14:30
   * Explain limit of participants
