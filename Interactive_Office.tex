...
\paragraph{TODO}\todo{write something about these things}
\begin{itemize}
  \item Experiment preparation
  \item Result evaluation
\end{itemize}

\paragraph{Summary of Crowdboard paper} Citation: \cite{crowdboard}\todo{Add actuall summary}
...
\paragraph{Initial Task for Crowdboard Session}\todo{finalize initial task}
\begin{itemize}
